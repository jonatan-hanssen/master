...
plot(id_transformed[:, 0], 'id')
plot(near_transformed[:, 0], 'near')
plot(far_transformed[:, 0], 'far')
plt.xlabel('grads')
plt.title('pca')
plt.legend()
plt.show()

plot(id_grads_stds, 'id')
plot(near_grads_stds, 'near')
plot(far_grads_stds, 'far')
plt.xlabel('grads')
plt.title('stds')
plt.legend()
plt.show()
...
plot(id_grads_mean, 'id')
plot(near_grads_mean, 'near')
plot(far_grads_mean, 'far')
plt.xlabel('grads')
plt.title('Mean')
plt.legend()
plt.show()
