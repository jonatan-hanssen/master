...
\begin{enumerate}
  ...
  \item Perform experiments to measure the performance of this novel method in comparison current State-of-the-Art OOD detection methods
\end{enumerate}

\section{Scope}

Use only post-hoc methods, pretrained resnet models. Use well established OOD datasets first for comparisons. Then focus on medical datasets, hyperkvasir and maybe more.

\section{Research Methods}

Bruk ACM paradigme kanskje? Flere bruker det

\section{Main Contributions}

Masse bra forhåpentligvis
