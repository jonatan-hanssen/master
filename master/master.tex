...
\begin{enumerate}
  ...
  \item Develop an OOD detection method which is inspired by insights gained from the field of XAI
...
Use only post-hoc methods, pretrained resnet models. Use well established OOD datasets first for comparisons. Then focus on medical datasets, hyperkvasir and maybe more. Only use open-source programs. Python and Pytorch.
...
Objective 1 is accomplished in chapter \ref{chapter:background}. Objective 2 is achieved in chapter \ref{chapter:newmethod}. Objective 3 is accomplished in chapter \ref{chapter:experiments}.
...
This chapter gives a short introduction to important concepts in the field of machine learning generally, followed by a more in depth look at the fields of XAI and OOD detection.
