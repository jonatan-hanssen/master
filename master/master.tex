...
In this chapter, I have presented the results from inspecting saliency aggregation over the validation dataset, as well as reported results of the three different \ac{xai} based \ac{ood} detection algorithms I introduced in chapter \ref{chapter:methodology}. As we have seen, the results are very promising, and show that there is definite potential for using \ac{xai} methods for \ac{ood} detection.
