...
\begin{figure}[hbtp]
    ...
    \node[SIR, align=center, minimum width=9em] (ooddetector) {OOD\\Detector};
    ...
    \node[SIR, align=center, minimum width=6.7em, right=11.5 em of inaturalistscores.west, anchor=west, fill=far!50] (inaturalistauroc) {AUROC:\\0.88};
